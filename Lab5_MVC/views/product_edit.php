...
<head>
    ...
    <title>Chỉnh sửa sản phẩm - <?= htmlspecialchars($product['name']) ?></title>
        ...
        <div class="col-md-8">
            ...
            <div class="form-container p-4">
                ...
                <form action="index.php?page=product-update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <p><strong>Mã sản phẩm:</strong> <span class="badge bg-primary">#<?= $product['id'] ?></span></p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-2 mt-4">
                        ...
                        <a href="index.php?page=product-detail&id=<?= $product['id'] ?>" class="btn btn-secondary btn-lg">
                            Hủy
                        </a>
                    </div>
                </form>
            ...
            <div class="alert alert-info mt-4" role="alert">
                <strong>Hướng dẫn:</strong> Chỉnh sửa thông tin sản phẩm rồi nhấn "Cập nhật sản phẩm" để lưu thay đổi.
            </div>
        </div>
    </div>
</div>
